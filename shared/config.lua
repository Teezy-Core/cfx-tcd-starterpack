...
Config.Locations = {
    ["1"] = {                                                                       -- Unique identifier for the location
        ...
        coords           = vector4(220.08, -954.28, 30.32, 19.52), -- Coordinates and heading of the NPC (ped)
        ...
        starter_vehicle  = {         -- Vehicle settings for players receiving a starter vehicle
            ...
            vehicle_spawns = {       -- Spawn points for the vehicle (multiple spawn locations)
                vector4(237.52, -957.84, 28.76, 160.68),
                vector4(241.76, -946.12, 28.76, 160.32),
                vector4(234.76, -965.68, 28.76, 157.8),
            },
...
Config.StarterPackItems = { -- items that will be given to player
    ["normal"] = {
        ...
        { item = 'burger',   amount = 15 },
        { item = 'water',   amount = 15 },
        { item = 'lockpick', amount = 15 },
        { item = 'money', amount = 50000 },
        { item = 'phone', amount = 1 },
        { item = 'chargingcable', amount = 1 },
        { item = 'powerbank', amount = 1 },
